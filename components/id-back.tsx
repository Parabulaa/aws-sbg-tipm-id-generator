    ...
    <div className="relative flex h-full flex-col overflow-hidden bg-[#fffaf0] text-slate-950">
      ...
      <main className="relative z-10 flex-1 px-7 pt-4">
        ...
        <section className="mt-8 border-t border-slate-200 pt-5">
          <h4 className="text-[9px] font-black uppercase tracking-[0.2em] text-amber-700">Terms and Conditions</h4>
      ...
      <footer className="relative z-10 mt-auto bg-slate-950 px-7 py-6 text-white">
        <p className="text-[10px] font-semibold italic text-amber-300">It&apos;s always day one.</p>
